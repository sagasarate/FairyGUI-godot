...
public class TransitionDemo : FairyGUI.Window
{
    static TransitionDemo _instance;
    public static TransitionDemo inst
    {
        get
        {
            if (_instance == null)
                _instance = new TransitionDemo();
            return _instance;
        }
    ...
    {
        UIPackage.AddPackage("res://Examples/Resources/Transition.res");
    }
    protected override void OnInit()
    {
        contentPane = UIPackage.CreateObject("Transition", "Main").asCom;
        MakeFullScreen();

        _btnGroup = contentPane.GetChild("g0").asGroup;
        ...
        contentPane.GetChild("btn0").onClick.Add(() => { __play(_g1); });
        contentPane.GetChild("btn1").onClick.Add(() => { __play(_g2); });
        contentPane.GetChild("btn2").onClick.Add(() => { __play(_g3); });
        contentPane.GetChild("btn3").onClick.Add(__play4);
        contentPane.GetChild("btn4").onClick.Add(__play5);
        contentPane.GetChild("btn5").onClick.Add(() => { __play(_g6); });
    }
    ...
    void __play5()
    {
        ...
        _startValue = 10000;
        int add = RandomUtil.Range(1000, 3000);
