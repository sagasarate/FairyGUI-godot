namespace FairyGUI
{
    ...
    public class EventBridge
    {
        ...
        public int listenerCount
        {
            get
            {
                return (_callback0 != null ? _callback0.GetInvocationList().Length : 0) +
                    (_callback1 != null ? _callback1.GetInvocationList().Length : 0) +
                    (_captureCallback != null ? _captureCallback.GetInvocationList().Length : 0);
            }
        }
