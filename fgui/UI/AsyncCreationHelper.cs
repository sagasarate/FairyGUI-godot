...
namespace FairyGUI
{
    public partial class AsyncCreationHelper : Node
    {
        public static AsyncCreationHelper Instance = null;
        public void CreateObject(PackageItem item, UIPackage.CreateObjectCallback callback)
        {
            _ = _CreateObject(item, callback);
        }

        async Task _CreateObject(PackageItem item, UIPackage.CreateObjectCallback callback)
        {
        ...
        int CollectComponentChildren(PackageItem item, List<DisplayListItem> list)
        {
        ...
        int CollectListChildren(ByteBuffer buffer, List<DisplayListItem> list)
        {
