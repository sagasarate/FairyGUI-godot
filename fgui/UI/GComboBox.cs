    ...
    public class GComboBox : GComponent
    {
        ...
        override protected void ConstructExtension(ByteBuffer buffer)
        {
            ...
            if (str != null)
            {
                ...
                if (dropdown == null)
                {
                    GD.PushError("FairyGUI: " + this.resourceURL + " should be a component.");
                    return;
                }
                ...
                if (_list == null)
                {
                    GD.PushError("FairyGUI: " + this.resourceURL + ": should container a list component named list.");
                    return;
                }
        ...
        protected void ShowDropdown()
        {
            ...
            {
                dropdown.onRemovedFromStage.Add(__popupWinClosed);
                SetState(GButton.DOWN);
            }
        }
        ...
        {
            dropdown.onRemovedFromStage.Remove(__popupWinClosed);
            SetCurrentState();
