    ...
    public class PopupMenu : EventDispatcher
    {
        ...
        void Create(string resourceURL)
        {
            if (resourceURL == null)
            {
                ...
                if (resourceURL == null)
                {
                    GD.PushError("FairyGUI: UIConfig.popupMenu not defined");
                    return;
                }
            }
        ...
        public void AddSeperator(int index)
        {
            ...
            {
                GD.PushError("FairyGUI: UIConfig.popupMenu_seperator not defined");
                return;
            }
        ...
        void ShowSubMenu(GObject item)
        {
            ...
            Vector2 pt = contentPane.LocalToRoot(new Vector2(item.x + item.width - 5, item.y - 5));
